        ...
        for symbol, productions in sorted_rules.items():
            ...
            if isinstance(ex, VarExpr) and ex.var.name == symbol.name:
                ...
                if isinstance(ex, Ite):
                    ...
                    for left in self.do_derivation(ex.left_operand, sorted_rules, available_vars):
                        for right in self.do_derivation(ex.right_operand, sorted_rules, available_vars):
